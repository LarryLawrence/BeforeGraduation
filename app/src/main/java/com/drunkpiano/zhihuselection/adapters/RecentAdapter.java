/*
 * This adapter is used for displaying the Recent viewpager.
 * @author DrunkPiano
 * @version 1.1.2
 * Modifying History:
...
public class RecentAdapter extends RecyclerView.Adapter {
    ...
    public RecentAdapter(Context mContext, String mTableName, int mCount,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        QueryData();//maybe this should be put somewhere else where it can only execute once
